...
currentYellow = 0 
speeds = {'car':3.75, 'bus':2.8, 'truck':2.8, 'bike':4.2}
x = {'right':[0,0,0], 'down':[755,757,727], 'left':[1400,1400,1400], 'up':[602,627,657]}    
y = {'right':[338,335,365], 'down':[0,0,0], 'left':[498,436,405], 'up':[800,800,800]}
vehicles = {'right': {0:[], 1:[], 2:[], 'crossed':0}, 'down': {0:[], 1:[], 2:[], 'crossed':0}, 'left': {0:[], 1:[], 2:[], 'crossed':0}, 'up': {0:[], 1:[], 2:[], 'crossed':0}}
vehicleTypes = {0:'car', 1:'bus', 2:'truck', 3:'bike'}
directionNumbers = {0:'right', 1:'down', 2:'left', 3:'up'}
signalCoods = [(530,210),(850,210),(850,530),(530,530)]
signalTimerCoods = [(530,190),(850,190),(850,510),(530,510)]
...
randomGreenSignalTimer = Truehere 
