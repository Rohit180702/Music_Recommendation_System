...
print("Enter 0 for video input and 1 for audio input...")
name = input("Enter your Mode to Access: ")
name = int(name)
if name == 0:
    print("You are using video input..")
    finale = webcam()
elif name == 1:
    print("You are using min input..")
    finale = mic()
